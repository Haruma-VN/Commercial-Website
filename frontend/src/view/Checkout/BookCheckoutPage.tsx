...
const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            if (!response.ok) {
                ...
                throw new Error("Có lỗi xảy ra trong quá trình xử lý gửi request đến server, không thể lấy thông tin sách");
            }
    ...
    return (
        <div>
            <Toast onClose={() => setToastVisible(false)} isVisible={toastVisible} message="Đã thêm sách thành công" bgColor="success" />
